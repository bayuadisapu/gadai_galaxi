...
/// Generate notifikasi otomatis dari mock data
List<_Notif> _generateNotifications() {
...
class _NotificationPanelState extends State<NotificationPanel> {
  ...
  void initState() {
    super.initState();
    _notifs = _generateNotifications();
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        if (unreadCount > 0)
                          Text('$unreadCount belum dibaca', style: const TextStyle(color: AppColors.textMuted, fontSize: 12)),
                      ],
                    ),
                    if (unreadCount > 0)
                      TextButton(
                        ...
                        itemBuilder: (context, i) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              setState(() {
                                _notifs[i] = _Notif(
                                  title: n.title, body: n.body, icon: n.icon,
                                  color: n.color, time: n.time, isRead: true,
                                );
                              });
                            },
                            child: Container(
